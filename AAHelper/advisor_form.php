...
<?php 
	...
	elseif ($studentMajor == 'CIS') {
		$studentMajor = "Computer Info Systems";
	}
			    ...
			    ?>
					...
					while ($row = $result->fetch_array()) {
						...
						if ($row['required'] == "ELECTIVE" && $electiveSection == FALSE) { ?>
							<tr>
								<th colspan="19" class="className table-title" style="background-color: #757388; border: 1px solid #757388; padding:5px 8px; color:white; font-weight:400;">Elective Classes (12 Units)</th>
							</tr>
